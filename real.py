...
#WEEK 1 IS BROKEN CANT RABBIT HOLE INTO FIXING, WILL FIGURE OUT LATER
""""
FINAL VERSION OF AI PROJECT FOR SUBMISSION. REALER THAN REAL MY DUDES. NICHOLAS DUGAL
"""
def main(dataPath):

    position = 'qb'             # Hardcoded position will change
    posPath = dataPath + '/'+position     # Path to position data
...
if __name__ == '__main__': main(dataPath='/Users/nickdugal/documents/fantasy-football/data')
