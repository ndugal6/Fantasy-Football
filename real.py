...
def ensure_dir(file_path):
    ...
    directory = os.path.dirname(
        file_path)  # there's a race condition - if the directory is created between the os.path.exists
...
def purgeAlphas(unCleaned):
    cleaned = (set(list(unCleaned))).difference(
        ['Name', 'Opponent', 'Position', 'Opponent_x', 'Position_x', 'Team', 'Opponent_y', 'Position_y', 'Unnamed: 0',
         'Unnamed: 0.1_x',
